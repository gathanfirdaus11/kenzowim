...
<body>
    ...
    <div class="container-fluid bg-light py-3">
        ...
        <div class="container text-center mt-5">
            <h2>Kategori</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, aliquid.</p>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-4 py-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Sepeda Gunung Cross Country</h5>
                            <a href="#" class="btn btn-primary">Rp1.000.000</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 py-3">
                    <div class="card">
                        <img src="https://media.rodalink.com/catalog/product/cache/image/680x510/e9c3970ab036de70892d86c6d221abfe/7/3/738521.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Sepeda BMX Freestyle</h5>
                            <a href="#" class="btn btn-primary">Rp400.000</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 py-3">
                    <div class="card">
                        <img src="https://www.wimcycle.com/wp-content/uploads/2024/02/MY24-VULCAN-BLUE-P.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Sepeda Jalanan Aero</h5>
                            <a href="#" class="btn btn-primary">Rp500.000</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-4 py-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Sepeda Gunung</h5>
                            <p class="card-text">Sepeda Gunung adalah jenis sepeda yang dirancang khusus untuk digunakan di medan berat atau off-road</p>
                ...
                <div class="col-12 col-sm-6 col-lg-4 py-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Sepeda BMX adalah singkatan dari Bicycle Motocross. Ini adalah jenis sepeda yang dirancang khusus untuk olahraga dan aksi</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 py-3">
                    <div class="card">
                        <img src="https://www.wimcycle.com/wp-content/uploads/2024/02/MY24-VULCAN-BLUE-P.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Sepeda Jalanan</h5>
                            <p class="card-text">Sepeda jalanan, atau road bike, adalah jenis sepeda yang dirancang khusus untuk digunakan di jalan raya yang beraspal</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                        </div>
                    </div>
                </div>
